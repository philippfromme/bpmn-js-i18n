 ...
 */
export default function TranslationPropertiesProvider(propertiesPanel, injector, translate) {
...
TranslationPropertiesProvider.$inject = [ 'propertiesPanel', 'injector', 'translate' ];
