 ...
 */
export default function BpmnInternationalizationPropertiesProvider(propertiesPanel, injector, translate) {
...
BpmnInternationalizationPropertiesProvider.$inject = [ 'propertiesPanel', 'injector', 'translate' ];
