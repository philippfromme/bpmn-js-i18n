...
import { getExtensionElementsList } from './provider/internationalization/properties/utils/ExtensionElementsUtil';

export default class BpmnInternationalization {
  ...
  getDefaultLanguage() {
    return this._bpmnjs.getDefinitions().get('xml:lang');
  }
...
BpmnInternationalization.$inject = [
  'bpmnjs',
  'elementRegistry',
  'eventBus',
  'graphicsFactory',
